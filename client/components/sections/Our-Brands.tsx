...
//               className="group relative flex flex-col items-center justify-center p-10 bg-neutral-100 hover:bg-gradient-to-br hover:from-neutral-100 hover:to-neutral-200 transition duration-300"
//             >
...
export default function OurBrands() {
  ...
  const brands = [
    { nameKey: 'brands.names.tesla',       icon: siTesla,       make: 'Tesla'       },
    { nameKey: 'brands.names.bmw',         icon: siBmw,         make: 'BMW'         },
    { nameKey: 'brands.names.audi',        icon: siAudi,        make: 'Audi'        },
    { nameKey: 'brands.names.volkswagen',  icon: siVolkswagen,  make: 'Volkswagen'  },
    { nameKey: 'brands.names.toyota',      icon: siToyota,      make: 'Toyota'      },
    { nameKey: 'brands.names.honda',       icon: siHonda,       make: 'Honda'       },
    { nameKey: 'brands.names.hyundai',     icon: siHyundai,     make: 'Hyundai'     },
    { nameKey: 'brands.names.nissan',      icon: siNissan,      make: 'Nissan'      },
    { nameKey: 'brands.names.ford',        icon: siFord,        make: 'Ford'        },
    { nameKey: 'brands.names.chevrolet',   icon: siChevrolet,   make: 'Chevrolet'   },
    { nameKey: 'brands.names.porsche',     icon: siPorsche,     make: 'Porsche'     },
    { nameKey: 'brands.names.ferrari',     icon: siFerrari,     make: 'Ferrari'     },
    { nameKey: 'brands.names.lamborghini', icon: siLamborghini, make: 'Lamborghini' },
    { nameKey: 'brands.names.maserati',    icon: siMaserati,    make: 'Maserati'    },
    { nameKey: 'brands.names.bugatti',     icon: siBugatti,     make: 'Bugatti'     },
    { nameKey: 'brands.names.peugeot',     icon: siPeugeot,     make: 'Peugeot'     },
  ];
          ...
          {brands.map((brand, index) => (
            ...
            >
              <motion.div
                ...
                viewport={{ once: false }}
                transition={{ delay: index * 0.03 }}
                className="group relative flex flex-col rounded-xl items-center justify-center p-10 bg-neutral-100 hover:bg-gradient-to-br hover:from-neutral-100 hover:to-neutral-200 transition duration-300 cursor-pointer"
              >
                <svg viewBox="0 0 24 24" width={44} height={44} className="text-neutral-600 group-hover:text-[#C8A24A] group-hover:scale-110 transition duration-300 relative">
                  <path d={brand.icon.path} fill="currentColor" />
                </svg>
